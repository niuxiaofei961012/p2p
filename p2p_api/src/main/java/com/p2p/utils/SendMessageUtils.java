...
public class SendMessageUtils {
    ...
    /**
     * @param Uid SMS用户id  ： niuxiaofei961012
...
//        SendMessageUtil.send("SMS账户","接口秘钥","目标号码","发送内容");
        Integer send = SendMessageUtils.send("niuxiaofei961012", "d41d8cd98f00b204e980", "17600156731", "验证码:" + getRandomCode(6));
        System.out.println(SendMessageUtils.getMessage(send));
    }
}
