    ...
    <el-form ref="form" :model="form" label-width="80px">
      ...
      <el-form-item label="还款方式">
        <el-radio-group v-model="form.paymentMethod">
          <el-radio label="等额本息" value="0"></el-radio>
          <el-radio label="等额本金" value="1"></el-radio>
          <el-radio label="按月到期" value="2"></el-radio>
        </el-radio-group>
      </el-form-item>

      <el-form-item label="贷款期限">
        <el-select v-model="form.returnMonthes" placeholder="请选择贷款期限" @change="computerMoney">
          <el-option label="请选择期限" value=""></el-option>
